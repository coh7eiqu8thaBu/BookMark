...
[HKCU\Software\Microsoft\SystemCertificates\CA\PhysicalStores\Hello] "OpenStoreProvider"="HelloProv" @=""
[HKLM\SOFTWARE\Microsoft\Cryptography\OID\EncodingType 0\CertDllOpenStoreProv\helloprov] "Dll"="C:\\temp\\hello.dll" "FuncName"="HelloFunc"
1) Triggered when anything works with certificates 2) As well, consent.exe or svchost.exe with high privileges 3) Not listed at autoruns

Red teams can now bypass the new Windows 10 PowerShell Script logging without admin privileges
https://www.peerlyst.com/posts/red-teams-can-now-bypass-the-new-windows-10-powershell-script-logging-without-admin-privileges-gina-robertson
...
IRMA is an asynchronous & customizable analysis system for suspicious files. https://irma.quarkslab.com
...
KeySweeper is a stealthy Arduino-based device, camouflaged as a functioning USB wall charger, that wirelessly and passively sniffs, decrypts, logs and reports back (over GSM) all keystrokes from any Microsoft wireless keyboard in the vicinity. https://samy.pl/keysweeper/
...
https://gist.github.com/dirkjanm/acbd85799b23fc7662f9826ace7bd917
...
https://n0where.net/advanced-browser-exploit-pack-browserexploit
...
Burp Suite Extensions Collection:
 - https://t.co/uZsqEapYza
 - https://t.co/VUHGMPOqD0
 - https://t.co/VR1RVF2QbE
 - https://t.co/XVER8zJOG7
 - https://t.co/4YeeLw9rOF
 - https://t.co/WPtRFE2jeQ
 - https://t.co/NOrgToXF3D
 - https://t.co/vkY0n8NZAi
 - https://t.co/aHF65GhjSW
 - https://t.co/JPpnMr3MlM
...
https://lem.click/post/letsencrypt-proxy-dns-authentication/
...
⌨️ Wordlists, Dictionaries and Other Data Sets for Writing Software Security Test Cases https://decal.github.io/werdlists
...
OWASP Joomla Vulnerability Scanner Project https://www.owasp.org/index.php/Categ…
...
https://www.linkedin.com/pulse/dangerous-tutorials-how-learn-c-cryptography-graham-steel
...
An Android app that lets you use your access control card cloning devices in the field. https://walrus.app/
...
https://0x00sec.org/t/realmode-assembly-writing-bootable-stuff-part-4/3317
...
http://www.hackingarticles.in/burpsuite-encoder-decoder-tutorial/
...
https://www.kitploit.com/2018/10/takeover-v1-extracts-cname-record-of.html
...
https://www.kitploit.com/2018/09/seeker-v107-get-accurate-location-using.html
...
https://gist.github.com/realoriginal/10d8c98845d85b03c552843bf7e1e4db

This is a collection of security tools and toolkits that can be useful for you, if you are interested in information security.
https://www.encripto.no/en/downloads-2/tools/

Blue Team Training Toolkit (BT3)
https://www.bt3.no/

Device Driver 1 - Introduction https://embetronicx.com/tutorials/linux/device-drivers/linux-device-driver-part-1-introduction/
Device Driver 2 - First Driver https://embetronicx.com/tutorials/linux/device-drivers/linux-device-driver-tutorial-part-2-first-device-driver/
Device Driver 3 - Passing Arguments https://embetronicx.com/tutorials/linux/device-drivers/linux-device-driver-tutorial-part-3-passing-arguments-to-device-driver/
Device Driver 4 - Major & Minor Number https://embetronicx.com/tutorials/linux/device-drivers/character-device-driver-major-number-and-minor-number/
Device Driver 5 - Creating Device File https://embetronicx.com/tutorials/linux/device-drivers/device-file-creation-for-character-drivers/
Device Driver 6 - File Operations https://embetronicx.com/tutorials/linux/device-drivers/cdev-structure-and-file-operations-of-character-drivers/
...
https://www.kitploit.com/2018/10/darkspiritz-v20-penetration-testing.html
https://github.com/DarkSpiritz/DarkSpiritz

LORG – Apache Logfile Security Analyzer
http://www.sectechno.com/lorg-apache-logfile-security-analyzer/
...
Windows Command Line cheatsheet
	* part 1 - some useful tips - https://www.andreafortuna.org/technology/windows/windows-command-line-cheatsheet-part-1-some-useful-tips/
	* part 2 - WMIC - https://www.andreafortuna.org/dfir/windows-command-line-cheatsheet-part-2-wmic/
...
https://github.com/corkami/docs/blob/master/images/jpeg.md
...
http://wiki.infonotary.com/index.php/Installation_of_smart_card_reader_and_smart_card_drivers_in_Linux

SSL/TLS Deployment Best Practices
https://www.feistyduck.com/library/openssl-cookbook/online/apA-ssl-tls-deployment-best-practices.html
...
Subdomain list for bruteforcing : https://gist.github.com/michenriksen/60a5fd10968de2bbe0f6571b6a67e7bb
 all wordlists from every dns enumeration tool... ever. Please excuse the lewd entries =/ https://gist.github.com/jhaddix/86a06c5dc309d08580a018c66354a056

Extract subdomains from SSL certificates in HTTPS sites. https://franccesco.github.io/getaltname/
https://github.com/franccesco/getaltname

A list of names that should be reserved in multitenant apps https://www.npmjs.com/package/reserved-subdomains
